...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.EmploymentsServiceProxy,        
        ApiServiceProxies.JobApplyServiceProxy,        
        ApiServiceProxies.JobDemandsServiceProxy,        
        ApiServiceProxies.EmployeeServiceProxy,        
        ApiServiceProxies.CompanyServiceProxy,            
        ApiServiceProxies.CompanyCategoryServiceProxy,        
        ApiServiceProxies.CompanyTypeServiceProxy,        
        ApiServiceProxies.JobSkillServiceProxy,    
