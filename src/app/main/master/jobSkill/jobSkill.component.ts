...
@Component({
    templateUrl: './jobSkill.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class JobSkillComponent extends AppComponentBase {
    @ViewChild('createOrEditJobSkillModal', { static: true })
    createOrEditJobSkillModal: CreateOrEditJobSkillModalComponent;
    @ViewChild('viewJobSkillModal', { static: true }) viewJobSkillModal: ViewJobSkillModalComponent;
    ...
    getJobSkill(event?: LazyLoadEvent) {
