...
export class QualificationComponent extends AppComponentBase {
    @ViewChild('createOrEditQualificationModal', { static: true })
    createOrEditQualificationModal: CreateOrEditQualificationModalComponent;
    @ViewChild('viewQualificationModal', { static: true }) viewQualificationModal: ViewQualificationModalComponent;
    ...
    getQualification(event?: LazyLoadEvent) {
