...
export class CompanyTypeComponent extends AppComponentBase {
    @ViewChild('createOrEditCompanyTypeModal', { static: true })
    createOrEditCompanyTypeModal: CreateOrEditCompanyTypeModalComponent;
    @ViewChild('viewCompanyTypeModal', { static: true }) viewCompanyTypeModal: ViewCompanyTypeModalComponent;
    ...
    getCompanyType(event?: LazyLoadEvent) {
