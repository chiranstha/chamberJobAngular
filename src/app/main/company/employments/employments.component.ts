...
export class EmploymentsComponent extends AppComponentBase {
    @ViewChild('createOrEditEmploymentModal', { static: true })
    createOrEditEmploymentModal: CreateOrEditEmploymentModalComponent;
    @ViewChild('viewEmploymentModal', { static: true }) viewEmploymentModal: ViewEmploymentModalComponent;
    ...
    createEmployment(): void {
        this.createOrEditEmploymentModal.show();
    }
